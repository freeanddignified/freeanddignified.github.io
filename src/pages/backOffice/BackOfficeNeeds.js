...
const BackOfficeNeeds = () => {
  return <div>
            ...
            <div>
              <label for="name-c11f" >Ім'я</label>
              <input type="text" placeholder="Введите Ваше имя" id="name-c11f" name="name" required="">
            </div>
            <div>
              <label for="email-c11f">Эл. пошта</label>
              <input type="email" placeholder="Введите Ваш email адрес" id="email-c11f" name="email"required="">
            </div>
            <div >
              <label for="message-c11f">Запит</label>
              <textarea placeholder="Додайте ваш запит" rows="4" cols="50" id="message-c11f" name="message" required=""></textarea>
            </div>
            <div>
              <input type="checkbox" id="agree-3dbb" name="agree" required="">
              <label for="agree-3dbb">Я приймаю <a href="#">умови надання послуг</a>
              </label>
            </div>
            <div>
              <label for="select-7d46">Выбрати</label>
              <div>
